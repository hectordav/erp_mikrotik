        ...
        <div class="row">
                            ...
                            <p>
                                <tr>
                                    ...
                                    <?php foreach($columns as $column){?>
                                        <th class="" data-order-by="<?php echo $column->field_name; ?>"><?php echo $column->display_as; ?></th>
                                    <?php }?>
                                </tr>
            ...
            <div class="delete-confirmation modal fade">
                <div class="modal-dialog">
                    <div class="modal-content" style="top: 20%;left: 0%; z-index:1002; padding: 1px;  background: #fff;  z-index:1002;  overflow: auto;">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info" data-dismiss="modal"><?php echo $this->l('form_cancel'); ?></button>
