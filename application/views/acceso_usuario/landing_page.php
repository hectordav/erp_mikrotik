...
<!-- 	<link href='https://fonts.googleapis.com/css?family=Montserrat:400,700' rel='stylesheet' type='text/css'> -->
	...
	<!-- Animate.css -->
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/animate.css">
	<!-- Icomoon Icon Fonts-->
	<!-- <link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/icomoon.css"> -->
	<!-- Simple Line Icons-->
<!-- 	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/simple-line-icons.css"> -->
	<!-- Magnific Popup -->
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/magnific-popup.css">
	<!-- Owl Carousel -->
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/owl.carousel.min.css">
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/owl.theme.default.min.css">
	<!-- Salvattore -->
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/salvattore.css">
	<!-- Theme Style -->
	<link rel="stylesheet" href="<?=$this->config->base_url()?>assets/css/style.css">
	<!-- Modernizr JS -->
	<script src="<?=$this->config->base_url()?>assets/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<a href="index.html" class="navbar-brand"><img src="<?$this->config->base_url()?>../assets/img/Logo_blue_carrot_1.png" alt="Outline Free HTML5 Responsive Bootstrap Template" WIDTH=128 HEIGHT=38 BORDER=0></a>
				</div>
			</div>
		</div>
	</div>
	<div id="fh5co-page">
		<div id="fh5co-wrap">
			<header id="fh5co-hero" data-section="home" role="banner" style="background: url(images/bg_2.jpg) top left; background-size: cover;" >
				<div class="fh5co-overlay" style=" background: #FEDB1D; opacity: 1"></div>
				<div class="fh5co-intro">
					<div class="container">
						<div class="row">
							<div class="col-md-6 fh5co-text">
								<h2 class="to-animate intro-animate-1">Bluecarrot</h2>
								<p class="to-animate intro-animate-2">El canal para la publicidad, El marketing y las ventas mediante nuestras redes Free-wifi en Barcelona, Madrid, Sevilla, Bilbao, Valencia, Murcia…</p>
								<p class="to-animate intro-animate-3"><a href="#" class="btn btn-primary btn-md"><i class="fa-info-circle"></i>Mas Info</a></p>
							</div>
							<div class="col-md-6 text-right fh5co-intro-img to-animate intro-animate-4">
								<img src="<?$this->config->base_url()?>../assets/img/zana2.png" alt="Outline Free HTML5 Responsive Bootstrap Template">
							</div>
					...
					<div class="container">
						<div class="row text-center">
							<div class="col-md-3 col-sm-6 col-xs-6 to-animate">
								<figure class="fh5co-client"><img src="<?$this->config->base_url()?>../assets/img/client_1.png" alt="Free HTML5 Template"></figure>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6 to-animate">
								<figure class="fh5co-client"><img src="<?$this->config->base_url()?>../assets/img/client_2.png" alt="Free HTML5 Template"></figure>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6 to-animate">
								<figure class="fh5co-client"><img src="<?$this->config->base_url()?>../assets/img/client_3.png" alt="Free HTML5 Template"></figure>
							</div>
							<div class="col-md-3 col-sm-6 col-xs-6 to-animate">
								<figure class="fh5co-client"><img src="<?$this->config->base_url()?>../assets/img/client_4.png" alt="Free HTML5 Template"></figure>
							</div>
						</div>
					</div>
				</div>
	...
	<!-- jQuery Easing -->
	<script src="<?=$this->config->base_url()?>assets/js/jquery.easing.1.3.js"></script>
	<!-- Bootstrap -->
	<script src="<?=$this->config->base_url()?>assets/js/bootstrap.min.js"></script>
	<!-- Waypoints -->
	<script src="<?=$this->config->base_url()?>assets/js/jquery.waypoints.min.js"></script>
	<!-- Magnific Popup -->
	<script src="<?=$this->config->base_url()?>assets/js/jquery.magnific-popup.min.js"></script>
	<!-- Owl Carousel -->
	<script src="<?=$this->config->base_url()?>assets/js/owl.carousel.min.js"></script>
	<!-- toCount -->
	<script src="<?=$this->config->base_url()?>assets/js/jquery.countTo.js"></script>
	<!-- Main JS -->
