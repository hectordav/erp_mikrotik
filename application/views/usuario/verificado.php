...
<body align="center"  style="background-color: #FEDB1D">
   	 <div id="palabra" style="display:block">
   	  <IMG SRC="../assets/img/Logo_blue_carrot_1.png" class="animated fadeInRight" WIDTH=320 HEIGHT=96 BORDER=0 ALT="Bluecarrot"style="max-width:350px;">
...
<form action="<?=$this->config->base_url();?>usuario/enviar_cliente_mail" method="POST" accept-charset="utf-8">
	<div class="col-md-6 col-sm-6 col-xs-6">
	<label><h2>Revisa tu Bandeja de entrada para continuar con el registro</h2></label>
		<br>
     <h2><a href="<?=$this->config->base_url()?>acceso_usuario" title=""><button type="button" class="btn btn-success">Volver a Home</button></a></h2>
	</div>
				</div>
