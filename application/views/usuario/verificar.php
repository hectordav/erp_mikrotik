...
<form action="<?=$this->config->base_url();?>usuario/enviar_cliente_mail" method="POST" accept-charset="utf-8">
	<div class="col-md-6 col-sm-6 col-xs-6">
		<input type="email" name="txt_correo" id="txt_correo" class="form-control" value="" placeholder="Ingrese su email" required="required" title="">
		<br>
	</div>
				</div>

       <button type="submit" class="btn btn-success">Verificar Mail</button>
       </form>
